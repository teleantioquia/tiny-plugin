...
class Tiny_Plugin {
	...
	public function __construct() {
		if ( defined( 'TINY_PLUGIN_VERSION' ) ) {
			$this->version = TINY_PLUGIN_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'tiny-plugin';
	 ...
	 *
	 * - Tiny_Plugin_Loader. Orchestrates the hooks of the plugin.
	 * - Tiny_Plugin_i18n. Defines internationalization functionality.
	 * - Tiny_Plugin_Admin. Defines all hooks for the admin area.
	 * - Tiny_Plugin_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-tiny-plugin-admin.php';
	 ...
	 *
	 * Uses the Tiny_Plugin_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Tiny_Plugin_Loader    Orchestrates the hooks of the plugin.
	 */
